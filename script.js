  ...
  if (contactForm) {
    ...
    function showFieldError(field, message) {
      ...
      if (!errorEl) {
        ...
        if (field.name) errorEl.id = 'error-' + field.name;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd0c1a8c8-c335-4671-88a6-530cdd87d5dd',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd0c1a8c8-c335-4671-88a6-530cdd87d5dd';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd0c1a8c8-c335-4671-88a6-530cdd87d5dd';
